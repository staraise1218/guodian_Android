...
public class NavCategoryFragment1 extends BaseFragment {
...
//                startActivity(intent);
    ...
    public NavCategoryFragment1() {
    }

    public static NavCategoryFragment1 newInstance() {
        NavCategoryFragment1 fragment = new NavCategoryFragment1();
...
//        webSettings.setJavaScriptEnabled(true);
        ...
        sortListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                intent.putExtra("name", brands.get(position).getCat_name());
...
//                        if (categoryId == 0)
                        defaultClick(enums.getData().get(0).getId());
//                        else {
...
//                }
    ...
    private void defaultClick(String branchId) {
//
//        //默认选中第0个

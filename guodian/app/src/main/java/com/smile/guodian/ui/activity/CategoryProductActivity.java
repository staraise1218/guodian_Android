...
//                initData(categories.get(tab.getPosition()).getId()+"");
    ...
    public void initData(final String cat_id) {
...
//        params.put("page", page + "");
        ...
        OkHttp.post(this, HttpContants.BASE_URL + "/Api/category/goodsList?brand_id="+branch_id+"&shop_price=asc", params, new OkCallback() {
            @Override

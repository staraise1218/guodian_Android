...
public interface HttpContants {
    public static final String BASE_URL = "http://www.guodianjm.com";
...
//    public static final String BASE_URL = "http://112.124.22.238:8081/course_api/";       //url的基类
    ...
    public static final String CATEGORY_LIST = BASE_URL + "/Api/category/topCategoryList";
    //分类一级菜单

    public static final String WARES_LIST = BASE_URL + "/Api/category/cateBrandList";          //分类二级菜单

    public static final String LOGIN = BASE_URL + "/Api/Auth/login";                  //登录

...
import com.syz.commonpulltorefresh.lib.loadmore.DefaultLoadMoreFooter;
import com.syz.commonpulltorefresh.lib.loadmore.GridViewHandler;
import com.syz.commonpulltorefresh.lib.loadmore.ILoadViewMoreFactory;
import com.syz.commonpulltorefresh.lib.loadmore.ILoadViewMoreFactory.ILoadMoreView;
import com.syz.commonpulltorefresh.lib.loadmore.ListViewHandler;
import com.syz.commonpulltorefresh.lib.loadmore.OnLoadMoreListener;
import com.syz.commonpulltorefresh.lib.loadmore.OnScrollBottomListener;
import com.syz.commonpulltorefresh.lib.loadmore.RecyclerViewHandler;
import com.syz.commonpulltorefresh.lib.utils.PtrCLog;
...
public class PtrFrameLayout extends ViewGroup {
    ...
    public PtrFrameLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray arr = context.obtainStyledAttributes(attrs, com.syz.commonpulltorefresh.lib.R.styleable.PtrFrameLayout, 0, 0);
        if (arr != null) {

            mHeaderId = arr.getResourceId(com.syz.commonpulltorefresh.lib.R.styleable.PtrFrameLayout_ptr_header, mHeaderId);
            mContainerId = arr.getResourceId(com.syz.commonpulltorefresh.lib.R.styleable.PtrFrameLayout_ptr_content, mContainerId);

            mPtrIndicator.setResistance(
                    arr.getFloat(com.syz.commonpulltorefresh.lib.R.styleable.PtrFrameLayout_ptr_resistance, mPtrIndicator.getResistance()));

            mDurationToClose = arr.getInt(com.syz.commonpulltorefresh.lib.R.styleable.PtrFrameLayout_ptr_duration_to_close, mDurationToClose);
            mDurationToCloseHeader = arr.getInt(com.syz.commonpulltorefresh.lib.R.styleable.PtrFrameLayout_ptr_duration_to_close_header, mDurationToCloseHeader);

            float ratio = mPtrIndicator.getRatioOfHeaderToHeightRefresh();
            ratio = arr.getFloat(com.syz.commonpulltorefresh.lib.R.styleable.PtrFrameLayout_ptr_ratio_of_header_height_to_refresh, ratio);
            mPtrIndicator.setRatioOfHeaderHeightToRefresh(ratio);

            mKeepHeaderWhenRefresh = arr.getBoolean(com.syz.commonpulltorefresh.lib.R.styleable.PtrFrameLayout_ptr_keep_header_when_refresh, mKeepHeaderWhenRefresh);

            mPullToRefresh = arr.getBoolean(com.syz.commonpulltorefresh.lib.R.styleable.PtrFrameLayout_ptr_pull_to_fresh, mPullToRefresh);
            arr.recycle();
        }
